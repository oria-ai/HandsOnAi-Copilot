...
const StudentDashboard = () => {
  ...
  const getModuleProgress = (module: Module) => {
    if (!module.steps.length) return 0;
    ...
    const totalProgress = moduleProgress.reduce((sum, p) => sum + p.progressPercent, 0);
    return Math.round(totalProgress / module.steps.length);
  };
